        ...
        <div className="mx-auto max-w-7xl grid grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <SectionReveal variant="clip-left">
            <div className="relative aspect-4/3 overflow-hidden rounded-xl">
              <Image src="https://images.unsplash.com/photo-1528605248644-14dd04022da1?q=80&w=2070&auto=format&fit=crop" alt="Professional networking" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 50vw" />
            </div>
          </SectionReveal>
        </div>
      </section>
