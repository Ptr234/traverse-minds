...
const divisions = [
  { id: "security", name: "Cybersecurity", icon: Shield, desc: "End-to-end protection for critical infrastructure, banks, and government.", href: "/security", image: "/imagestouse/div-cybersecurity.jpeg" },
  { id: "think-tank", name: "Think Tank", icon: Brain, desc: "Independent research and policy analysis for the digital age.", href: "/think-tank", image: "/imagestouse/div-think-tank.jpeg" },
  { id: "public-record", name: "Public Record Africa", icon: Database, desc: "AI-powered transparency tool for accessing public documents.", href: "/public-record", image: "/imagestouse/div-public-record.jpeg" },
  { id: "events", name: "Events", icon: Calendar, desc: "High-level forums like the Cyber Luncheon for digital leaders.", href: "/events", image: "/imagestouse/div-events.jpeg" },
  { id: "media", name: "Media", icon: Mic, desc: "Amplifying narratives through podcasts, reports, and coverage.", href: "/media", image: "/imagestouse/div-media.jpeg" },
  { id: "literacy", name: "Digital Literacy", icon: BookOpen, desc: "Empowering SMEs and citizens with essential digital skills and safety.", href: "/literacy", image: "/imagestouse/div-literacy.jpeg" },
];
