...
const divisions = [
  ...
  { id: "public-record", name: "Public Record Africa", icon: Database, desc: "AI-powered transparency tool for accessing public documents.", href: "/public-record", image: "https://images.unsplash.com/photo-1568667256549-094345857637?q=80&w=2030&auto=format&fit=crop" },
