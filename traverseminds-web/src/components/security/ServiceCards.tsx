...
const services = [
  { icon: ScanEye, title: "Penetration Testing", description: "Simulated attacks on your networks, applications, and infrastructure to identify vulnerabilities before real attackers do.", image: "/imagestouse/cyber.jpg" },
  { icon: ShieldCheck, title: "ISO 27001 Compliance", description: "End-to-end support for achieving and maintaining ISO 27001 certification -- gap analysis, documentation, and audit preparation.", image: "/imagestouse/vde.jpeg" },
  { icon: FileCheck2, title: "Bank of Uganda Audit", description: "Cybersecurity assessments aligned with Bank of Uganda regulatory requirements for supervised financial institutions.", image: "/imagestouse/bfe.jpeg" },
  { icon: AlertTriangle, title: "Threat Modelling", description: "Systematic identification of threats to your systems and data, with prioritised mitigation strategies.", image: "/imagestouse/div-cybersecurity.jpeg" },
  { icon: Siren, title: "Incident Response", description: "Rapid containment, investigation, and recovery when a breach occurs. 24-hour response commitment.", image: "/imagestouse/tec.jpg" },
  { icon: Scale, title: "Regulatory Advisory", description: "Expert guidance on Uganda PDPA 2019, NIST, and African data protection frameworks.", image: "/imagestouse/tra.jpeg" },
];
